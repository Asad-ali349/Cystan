...
<html lang="en">
 ...
 -->
                                 ...
                                 <a href="deleteGroup.php?id=<?php echo $data2['id'];?>&table=company_docs&page=people_detail_page.php?id=<?php echo $id?>" onclick="return confirm('Are you sure?')"><i class="far fa-times-circle" style="color: red; font-size: 20px;" aria-hidden="true"></i></a>
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         ...
                                         <a href="block_unblock.php?id=<?php echo $data['id'];?>&table=company&page=people_detail_page.php?id=<?php echo $id?>&status=0" onclick="return confirm('Are you sure?')"><i class="far fa-times-circle" style="color: red; font-size: 20px;" aria-hidden="true"></i></a>
                                     </td>
