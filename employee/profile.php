...
if (isset($_POST['submit'])) {
    ...
    $sql=mysqli_query($conn,"UPDATE employee SET name='$name',email='$email',contact='$contact',street='$street',city='$city',zip='$zip',state='$state',country='$country' WHERE id='$user_id'");
        if ($sql==true) {
...
$admin=mysqli_query($conn,"SELECT * FROM employee");
