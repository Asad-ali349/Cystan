...
$lid=$_GET['id'];
$letter=mysqli_fetch_array(mysqli_query($conn,"SELECT letter_1.*,bureau.*,individual.name,individual.email,individual.street,individual.state,individual.city,individual.zip,individual.ssn,individual.signature,individual.phone FROM `letter_1` INNER JOIN bureau ON letter_1.b_id=bureau.id INNER JOIN service_requests ON service_requests.id=letter_1.req_id INNER JOIN individual on individual.id=service_requests.individual_id where letter_1.id='$lid'"));
                                                            ...
                                                            <div class="inv--product-table-section">
                                                                <div class="row">
                                                                    <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4 mt-5">
                                                                        <p class="inv-to">RE:  REQUEST FOR CREDIT REPORT</p>
                                                                        <p><?php echo "To Whom It May Concern:" ?></p>
                                                                    </div>
                                                                </div>
                                                                <p>
                                                                    Please send me a copy of my credit report. My identifying information is as follows:<br><br>
                                                                    <b>Name: </b><?php echo $letter['name']?><br><br>
                                                                    <b>SS#:</b> <?php echo $letter['ssn']?><br><br>
                                                                    <b>Address:</b> <?php echo $letter['street']?><br><br>
                                                                    <b>City,State,Zip:</b> <?php echo $letter['city'].",".$letter['state'].",".$letter['zip']; ?><br><br>
                                                                    <b>DOB:</b> <?php echo $letter['dob']?><br><br>
                                                                    <b>Past Residence:</b> <?php echo $letter['residence']?><br><br>
                                                                    <b>Former Name:</b> <?php echo $letter['former_name']?><br><br>
                                                                    Enclosed is $<?php echo $letter['balance']?> as payment for the credit report<br><br>
                                                                    <?php echo htmlspecialchars_decode($letter['note'])?><p/><p>
                                                                    <br>
                                                                    If you have any questions, please contact me at <?php echo $letter['phone']?>.<br><br>
                                                                    Thank you.<br><br>
                                                                    Sincerely,
                                                                </p>
                                    ...
                                    <div class="invoice-actions-btn">
                                        ...
                                        <div class="invoice-action-btn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-md-3 col-sm-6">
                                                    <a href="edit_letter1.php?lid=<?php echo $lid ?>" class="btn btn-primary btn-download">Edit</a>
                                                </div>
                                            </div>
