...
$lid=$_GET['id'];
$letter=mysqli_fetch_array(mysqli_query($conn,"SELECT letter_5.*,bureau.*,individual.name,individual.email,individual.street,individual.state,individual.city,individual.zip,individual.ssn,individual.signature,individual.phone FROM `letter_5` INNER JOIN bureau ON letter_5.b_id=bureau.id INNER JOIN service_requests ON service_requests.id=letter_5.req_id INNER JOIN individual on individual.id=service_requests.individual_id where letter_5.id='$lid'"));
                                                ...
                                                <div class="invoice-00001">
                                                    <div class="content-section">
                                                        ...
                                                        <div class="inv--detail-section inv--customer-detail-section mt-4">
                                                            ...
                                                            <div class="inv--product-table-section">
                                                                <div class="row">
                                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
                                                                        <p class="inv-to">RE: FAILURE TO RESPOND TO DELTETION/CORRECTION LETTER</p>
                                                                        <p><?php echo "To Whom It May Concern:" ?></p>
                                                                    </div>
                                                                </div>
                                                                <p>
                                                                    On <?php echo $letter['fdate']; ?>, I sent a letter requesting that you reinvestigate or delete disputed items from my credit report as well as place temporarily remove these items from my report during the investigation period.  As of this date, you have failed to respond to my request. A copy of my original letter is attached for your review. <br><br>

                                                                    The law stipulates that you must investigate within 30 days of receiving my letter and respond within 5 days of completing your investigation. You have not followed the stipulations of the law.  <br><br>

                                                                    I may suffer damages because I need to rely on an accurate and complete statement of my credit record and demand that you remove the disputed items from my report immediately as you failed to comply with the law. Otherwise, I will contact the Federal Trade Commission and advise them of your apparent disregard for consumer protection laws.</p>
                                                                    <?php 
                                                                        if ($letter['note']!="") {
                                                                            // code...
                                                                            echo htmlspecialchars_decode($letter['note']);     
                                                                        }?>
                                                                    <p>    
                                                                    If you have any questions or need additional information, please contact me at the address noted below.<br><br>
                                                            ...
                                                            <div class="col-md-12">
                                                                <img   src="<?php echo $letter['signature']; ?>" alt="Your signature will go here!" style="width: 100px;height: 70px;"/>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="invoice-actions-btn">
                                        ...
                                        <div class="invoice-action-btn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-md-3 col-sm-6">
                                                    <a href="edit_letter5.php?lid=<?php echo $lid ?>" class="btn btn-primary btn-download">Edit</a>
                                                </div>
                                            </div>
