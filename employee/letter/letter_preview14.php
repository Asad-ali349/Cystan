...
$lid=$_GET['id'];
$letter=mysqli_fetch_array(mysqli_query($conn,"SELECT letter_14.*,bureau.*,individual.name,individual.email,individual.street,individual.state,individual.city,individual.zip,individual.ssn,individual.signature,individual.phone FROM `letter_14` INNER JOIN bureau ON letter_14.b_id=bureau.id INNER JOIN service_requests ON service_requests.id=letter_14.req_id INNER JOIN individual on individual.id=service_requests.individual_id where letter_14.id='$lid'"));
                                                            ...
                                                            <div class="inv--product-table-section">
                                                                <div class="row">
                                                                    <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4 mt-5">
                                                                        <p class="inv-to">RE: MAILING-LIST RESTRICTIONS</p>
                                                                        <p><?php echo "To Whom It May Concern:" ?></p>
                                                                    </div>
                                                                </div>
                                                                <p>
                                                                    I do not wish to have my name, address, telephone number, credit file or other information sold or traded with any marketers. In addition, please do not allow credit issuers to prescreen my credit file for credit offers. <br><br>

                                                                    I am requesting that all information about me and my accounts remain private. I want my name, address and credit data excluded from your marketing lists.<br>
                                                                    <?php echo htmlspecialchars_decode($letter['note']) ?></p><p>
                                                                    Thank you for your assistance with this matter. <br><br>
                                    ...
                                    <div class="invoice-actions-btn">
                                        ...
                                        <div class="invoice-action-btn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-md-3 col-sm-6">
                                                    <a href="edit_letter14.php?lid=<?php echo $lid ?>" class="btn btn-primary btn-download">Edit</a>
                                                </div>
                                            </div>
