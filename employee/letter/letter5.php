<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"INSERT INTO `letter_5`(b_id,datee,fdate,req_id,note) VALUES('$bureau','$date','$fdate','$srid','$additional')");
        if ($add_letter) {
        	$get_id=mysqli_fetch_array(mysqli_query($conn,"SELECT id from letter_5 WHERE `b_id`='$bureau' AND `datee`='$date' AND `req_id`='$srid' AND `note`='$additional' AND `fdate`='$fdate'"));
                $lid=$get_id['id'];
        // echo $fdate;
                                ...
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" name="fdatee" required class="form-control"> 
                                        </div>
