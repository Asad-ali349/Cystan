<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"INSERT INTO `letter_7`(b_id,datee,req_id,additional) VALUES('$bureau','$date','$srid','$additional')");
        if ($add_letter) {
            $get_id=mysqli_fetch_array(mysqli_query($conn,"SELECT id from letter_7 WHERE `b_id`='$bureau' AND `datee`='$date' AND `req_id`='$srid'"));
                $lid=$get_id['id'];
                            ...
                            <div class="widget-content widget-content-area">
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-6" >
                                            <label>Bureaus:</label>
                                            <select class="form-control select2" required id="letter" name="bureau">
                                        ...
                                        <div class="form-group col-md-12" id="body">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <select class="form-control select2" required name="creditor[]">
                                                        <option class="" value="">Select Creditor</option>
                                                        <?php while ($data2=mysqli_fetch_array($creditors)) {?>
                                                        <option value="<?php echo $data2['id']?>"><?php echo $data2['title']?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
