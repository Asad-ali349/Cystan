                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                ...
                                <a href="deleteGroup.php?id=<?php echo $data2['id'];?>&table=service_request_docs&page=request_detail_page.php?id=<?php echo $id?>" onclick="return confirm('Are you sure?')"><i class="far fa-times-circle" style="color: red; font-size: 20px;" aria-hidden="true"></i></a>
