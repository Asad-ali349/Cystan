...
if (isset($_POST['submit'])) {
    ...
    $sql=mysqli_query($conn,"INSERT INTO `services`(`title`, `description`, `service_type`) VALUES ('$name','$note','$sType')");
    if ($sql==true) {
                                    ...
                                    <form action="" method="POST" >
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-12">
                                                <textarea type="text" class="form-control" id="" rows="5" name="note" placeholder="Enter Description "></textarea>
                                            </div>
                                             <hr>
                                        </div>
                                   
                                        <center><button type="submit" name="submit" class="btn btn-danger mt-3">Add Service</button></center>
                                    </form>
                                </div>
                            </div>
                        </div>
