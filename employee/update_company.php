                    ...
                    <div class="widget-content widget-content-area">
                        <form action="" method="POST">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="email" name="url" value="<?php echo $compData['website']?>" >
                            </div>
