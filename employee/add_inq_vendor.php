                                ...
                                <div class="widget-content widget-content-area">
                                    <form action="" method="POST" >
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="text" class="form-control" id="" name="business" placeholder="Enter Business Type" required>
                                            </div>
                                            <div class="form-group col-md-4">
                                        ...
                                        <center><button type="submit" name="submit" class="btn btn-danger mt-3">Add Vendor</button></center>
                                    </form>
                                </div>
                            </div>
                        </div>
