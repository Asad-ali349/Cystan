...
$sql=mysqli_query($conn,"SELECT * FROM pin_color LIMIT 1");
...
if (isset($_POST['submit'])) {
    ...
    $name=str_replace("'", "", $name);
        $addGroup=mysqli_query($conn,"INSERT INTO grouping(name,pin_color_id,category_id) VALUES('$name','$color','5')");
...
$groups=mysqli_query($conn,"SELECT * FROM grouping  WHERE category_id='5'");
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-2">
                                                <button type="submit" name="submit" class="btn btn-danger" style="height: 45px">Add Type</button>
                                            </div>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    <h5 class="modal-title"><?php echo "Update Document Type" ?></h5>
