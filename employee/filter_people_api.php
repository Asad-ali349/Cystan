...
if(  isset($_POST['city']) && isset($_POST['country']) && isset($_POST['state']) && isset($_POST['zip'])  && isset($_POST['minrev']) && isset($_POST['maxrev']) && isset($_POST['maxcre']) && isset($_POST['mincre']) && isset($_POST['group'] ) ){
    ...
    $query = "SELECT individual.*,grouping.name as group_name,grouping.pin_color_id FROM individual LEFT JOIN grouping ON individual.group_id=grouping.id";
    $conditions = array();
    ...
    $sql .=" AND individual.status='1' AND individual.manage_role='2' AND individual.manage_by='$user_id'"; 
