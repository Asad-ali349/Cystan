...
$groups=mysqli_query($conn,"SELECT grouping.*,pin_color.color_code FROM grouping LEFT JOIN pin_color ON pin_color.id=grouping.pin_color_id  WHERE category_id='2'");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing mt-4">
                <div class="col-lg-12 col-12 row"  style=""> 
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-12 n-chk">
                                                <?php 
                                                $groupss=mysqli_query($conn,"SELECT grouping.*,pin_color.color_code FROM grouping LEFT JOIN pin_color ON pin_color.id=grouping.pin_color_id  WHERE category_id='2'");
    ...
    <script src="assets/js/scrollspyNav.js"></script>
     <script>
        ...
        if (filter==0) {
             ...
             var val = 1
            $.post('people_loc_api.php', {id: val}).then((result)=> {
           ...
           result.loc.map((item, index)=> {
                ...
                var infowindow = new google.maps.InfoWindow({
                  content:' <div>'+
                            '  <a type="button" class="btn btn-light" style="width:100px;margin-bottom:5px;" target="blank" href="people_detail_page.php?id='+item.id+'">View</a>'+
                           ' </div>'+
                           ' <div>'+
            ...
            for (var i = 0; i < x.length; i++) {
                if (x[i].checked) {
                    if (count==0) {
                        gstring += '(individual.group_id ='+x[i].value;
                        count++;    
                    } else {
                        gstring += ' OR individual.group_id ='+x[i].value;
                    }
            ...
            $.post('filter_people_api.php', {city: city,state: state,zip: zip,country: country,minrev: minrev,maxrev: maxrev,mincre: mincre,maxcre: maxcre,group:gstring}).then((result)=> {
               console.log("result");
           console.log(result);
