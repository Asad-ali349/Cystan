                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div id="naics_content" class="form-group col-md-12">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <input type="text" class="form-control" id="input1"  value="<?php echo $compData['naics_code']?>" readonly required>
                                                </div>
                                                 <div class="form-group col-md-3">
                                                    <label for="inputEmail4">Description:</label> 
                                                    <input type="text" class="form-control" id="input2"  value="<?php echo $compData['description']?>" readonly required>
                                                </div>
                                                 <div class="form-group col-md-3">
                                                    <label for="inputEmail4">Institute:</label> 
                                                    <input type="text" class="form-control" id="input3"  value="<?php echo $compData['ins']?>" readonly required>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label for="inputEmail4">SIC Code:</label> 
                                                    <input type="text" class="form-control" id="input4"  value="<?php echo $compData['sic_code']?>" readonly required>
                                                </div>
                                             ...
                                             <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="id_number" name="id_number" value="<?php echo $compData['customer_id']?>">
                                            </div>
                                           ...
                                           <div class="form-group col-md-12 mt-4">
                                            ...
                                            <div class="form-group col-md-4">
                                             ...
                                             <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo $compData['latitude']?>" >
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputEmail4">Longitude:</label> 
                                                <input type="text" class="form-control" id="longitude" name="longitude" value="<?php echo $compData['longitude']?>" >
                                            </div>
                                             <hr>
