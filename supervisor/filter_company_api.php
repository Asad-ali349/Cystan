...
if(  isset($_POST['city']) && isset($_POST['country']) && isset($_POST['state']) && isset($_POST['zip'])  && isset($_POST['minrev']) && isset($_POST['maxrev']) && isset($_POST['maxcre']) && isset($_POST['mincre']) && isset($_POST['group'] ) ){
    ...
    if (count($conditions) > 0) {
        ...
        $supercompanies .= " WHERE " . implode(' AND ', $conditions);

    }
   
    $sql .=" AND company.manage_role='2' AND supervisor.id='$user_id' AND company.is_company='1'";
    $supercompanies .=" AND company.manage_role='1' AND company.managed_by='$user_id' AND company.is_company='1'"; 

    // print_r($supercompanies);  
   
    $sql_query=mysqli_query($conn,$sql);
    $sql_supercompanies=mysqli_query($conn,$supercompanies); 
    
    if (mysqli_num_rows($sql_query)>0 || mysqli_num_rows($sql_supercompanies)>0) {
            ...
            while ($data=$sql_supercompanies->fetch_array()) {
