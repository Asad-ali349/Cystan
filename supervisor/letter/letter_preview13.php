...
$lid=$_GET['id'];
$letter=mysqli_fetch_array(mysqli_query($conn,"SELECT letter_13.*,bureau.*,individual.name,individual.email,individual.street,individual.state,individual.city,individual.zip,individual.ssn,individual.signature,individual.phone FROM `letter_13` INNER JOIN bureau ON letter_13.b_id=bureau.id INNER JOIN service_requests ON service_requests.id=letter_13.req_id INNER JOIN individual on individual.id=service_requests.individual_id where letter_13.id='$lid'"));
                                                            ...
                                                            <div class="inv--product-table-section">
                                                                <div class="row">
                                                                    <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4 mt-5">
                                                                        <p class="inv-to">RE: REQUEST TO UPDATE FOR COMPLETENESS OF ACCOUNT HISTORY</p>
                                                                        <p><?php echo "To Whom It May Concern:" ?></p>
                                                                    </div>
                                                                </div>
                                                                <p>
                                                                    I received a copy of my credit report and am disputing information concerning my payment history. Accordingly, I am requesting that you investigate my dispute and add the attached history of payments to my credit file under the Fair Credit Reporting Act, § 611(a) [15 USC 1681i (a)]. <br><br>

                                                                    I am requesting an updated copy of my credit report, which should be sent to the address listed below. According to the provisions of § 612 [15 USC § 1681j], there should be no charge for this report. Additionally, if you contact any entity (person or company) in order to make the necessary updates, please provide the names, business address and telephone numbers so that I may follow up directly if needed.<br>
                                    ...
                                    <div class="invoice-actions-btn">
                                        ...
                                        <div class="invoice-action-btn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-md-3 col-sm-6">
                                                    <a href="edit_letter13.php?lid=<?php echo $lid ?>" class="btn btn-primary btn-download">Edit</a>
                                                </div>
                                            </div>
