<?php 
    ...
    $lid=$_GET['lid'];
    $letter10=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM letter_10 WHERE id='$lid'"));
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"UPDATE `letter_10` SET b_id='$bureau',datee='$date',note='$additional',consumer_statement='$consumer_statement' WHERE id='$lid'");
        if ($add_letter) {
                                ...
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            <label>Date:</label>
                                            <input type="date" name="date" value="<?php echo $letter10['datee']; ?>" class="form-control" required> 
                                        </div>
                                        ...
                                        <div class="form-group col-md-12 mt-4" >
                                            ...
                                            <textarea id="editor" name="consumer_statement" rows="5" required><?php echo $letter10['consumer_statement']; ?></textarea>
                                        </div>
                                        <div class="form-group col-md-12 mt-4" >
                                            <label>Additional Notes</label>
                                            <textarea id="editor1" name="additional" rows="5"><?php echo $letter10['note']; ?></textarea>
                                        </div>
                                        <hr>
                                    </div>
