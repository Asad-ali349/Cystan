<?php 
    ...
    $lid=$_GET['lid'];
    $letter14=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM letter_14 WHERE id='$lid'"));
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"UPDATE `letter_14` SET b_id='$bureau',datee='$date',note='$additional' WHERE id='$lid' ");
        if ($add_letter) {
            header("Location: letter_preview14.php?id=$lid");    
        }else{
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h2>Mailing-List Restrictions </h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            <label>Date:</label>
                                            <input type="date" name="date" value="<?php echo $letter14['datee']; ?>" class="form-control" required> 
                                        </div>
                                        <div class="form-group col-md-6" >
                                            <label>Bureau:</label required>
                                        ...
                                        <div class="form-group col-md-12 mt-4" >
                                            ...
                                            <textarea id="editor" name="additional" rows="5"><?php echo $letter14['note'] ?></textarea>
                                        </div>
                                        <hr>
                                    </div>
