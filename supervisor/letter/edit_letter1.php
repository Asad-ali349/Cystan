<?php 
    ...
    $lid=$_GET['lid'];
    // $sid=$_GET['sid'];
    $letter1=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM letter_1 WHERE id='$lid'"));
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"UPDATE `letter_1` SET b_id='$bureau',datee='$date',note='$additional',dob='$dob',residence='$residence',former_name='$fname',balance='$balance' WHERE id='$lid'");
        if ($add_letter) {
                                ...
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            <label>Date:</label>
                                            <input type="date" name="date" value="<?php echo $letter1['datee']?>" class="form-control" required> 
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>DOB:</label>
                                            <input type="date" name="dob" class="form-control" value="<?php echo $letter1['dob']?>" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Past Residence:</label>
                                            <input type="text" name="residence" class="form-control" value="<?php echo $letter1['residence']?>" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Former Name:</label>
                                            <input type="text" name="fname" value="<?php echo $letter1['former_name']?>" class="form-control" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>balance:</label>
                                            <input type="text" value="<?php echo $letter1['balance']?>" name="balance" class="form-control" required>
                                        </div>
                                        
                                        
                                        <div class="form-group col-md-12 mt-4" >
                                            <label>Additional Notes</label>
                                            <textarea id="editor" name="additional" rows="5"><?php echo $letter1['note']?></textarea>
                                        </div>
                                        <hr>
                                    </div>
