<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"INSERT INTO letter_3(b_id,datee,req_id,note) VALUES('$bureau','$date','$srid','$additional')");
        if ($add_letter) {
            $get_id=mysqli_fetch_array(mysqli_query($conn,"SELECT id from letter_3 WHERE `b_id`='$bureau' AND `datee`='$date' AND `req_id`='$srid' AND `note`='$additional'"));
                $lid=$get_id['id'];
                            ...
                            <div class="widget-content widget-content-area">
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-6" >
                                            <label>Bureaus:</label>
                                            <select class="form-control select2" id="letter" required name="bureau">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control select2" name="reason[]" required>
                                                        ...
                                                        <?php
                                                            while ($data2=mysqli_fetch_array($reasons)) {
                                                            ?>
