...
if (isset($_SESSION['success']) && isset($_SESSION['error'])) {
  ...
  $ser_req=mysqli_query($conn,"SELECT service_requests.*,services.title,services.service_type,grouping.name as serType,individual.name as ind,individual.manage_by,individual.manage_role FROM service_requests JOIN individual ON individual.id=service_requests.individual_id INNER JOIN services ON service_requests.service_id=services.id INNER JOIN grouping ON services.service_type=grouping.id Where service_requests.status='1' AND individual.manage_role='1' AND individual.manage_by='$user_id' AND service_requests.is_deleted='0'  UNION SELECT service_requests.*,services.title,services.service_type,grouping.name as serType,individual.name as ind,individual.manage_by,individual.manage_role FROM supervisor INNER JOIN employee ON employee.supervisor_id=supervisor.id INNER JOIN individual ON individual.manage_by=employee.id INNER JOIN service_requests ON service_requests.individual_id=individual.id INNER JOIN services ON service_requests.service_id=services.id INNER JOIN grouping ON services.service_type=grouping.id where individual.manage_role='2' AND employee.supervisor_id='$user_id' AND service_requests.status='1' AND service_requests.is_deleted='0' ;");
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="delete_request.php?id=<?php echo $data['id'];?>&table=service_requests&page=due_payment_services_req.php&status=1"><i class="far fa-times-circle" onclick="return confirm('Are you sure?')" style="color: red; font-size: 18px; margin-left: 5px;" aria-hidden="true"></i></a>
