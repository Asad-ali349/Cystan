                ...
                <div class="col-lg-12 col-12 row"  style=""> 
                    ...
                    <div class="col-lg-12 col-12 layout-spacing"  style="">
                            ...
                            <div class=" row">
                                ...
                                ?>
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col mt-2" >
        ...
        if (filter==0) {
            ...
            result.loc.map((item, index)=> {
                ...
                var infowindow = new google.maps.InfoWindow({
                  content:' <div>'+
                            '  <a type="button" class="btn btn-light" style="width:100px;margin-bottom:5px;"  target="blank" href="company_detail_page.php?id='+item.id+'" >View</a>'+
                           ' </div>'+
                           ' <div>'+
