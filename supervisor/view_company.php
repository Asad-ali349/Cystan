...
$empployeecompanies=mysqli_query($conn,"SELECT employee.name as ename,company.*,grouping.name AS group_name,naics.sic_code,naics.naics_code,naics.description,naics.ins,individual.name as owner FROM supervisor LEFT JOIN employee ON employee.supervisor_id=supervisor.id LEFT JOIN company ON company.managed_by=employee.id LEFT JOIN grouping ON grouping.id=company.group_id LEFT JOIN naics ON naics.id= company.naics_id LEFT JOIN individual ON company.owned_by=individual.id WHERE company.manage_role='2' AND supervisor.id='$user_id' AND company.status='1'" );

$supercompanies=mysqli_query($conn,"SELECT company.*,grouping.name AS group_name,naics.sic_code,naics.naics_code,naics.description,naics.ins,individual.name as owner FROM company LEFT JOIN grouping ON grouping.id=company.group_id LEFT JOIN naics ON naics.id= company.naics_id LEFT JOIN individual ON company.owned_by=individual.id WHERE company.manage_role='1' AND company.managed_by='$user_id' AND company.status='1' ORDER BY company.id DESC" );
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="widget-content widget-content-area br-6 mt-2">
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    <?php  
                                        $count=1;
                                        while ($data=mysqli_fetch_array($supercompanies)) {
                                    ?>
                                    <tr>
                                    ...
                                    <?php  
                                        ...
                                        while ($data=mysqli_fetch_array($empployeecompanies)) {
                                    ?>
                                    <tr>
                                        <td><?php echo $count; ?></td>
                                        <td ><?php echo $data['name']; ?></td>
