...
if(isset($_POST["import"]))
{
  ...
  $extension=strtolower($file_ext);
     ...
     if(in_array($extension, $allowed_extension)) //check selected file extension is present in allowed extension array
     {
      ...
      include("../admin/PHPExcel/PHPExcel-1.8/Classes/PHPExcel/IOFactory.php"); 
      ...
      foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
      {
       ...
       for($row=2; $row<$highestRow; $row++)
       {
        ...
        $query="INSERT INTO company(name,website,contact,email,street,city,state,zip,country,review_avg,review_count,credit_score,anual_revenue,latitude,longitude,is_company,customer_id,loan_number,managed_by,added_by,roll,manage_role) VALUES('$name','$url','$phone','$email','$street','$city','$state','$zip','$country','$review_avg','$review_count','$credit_score','$annual_revinue','$latitude','$longitude','1','$id_number','$loan_number','$user_id','$user_id','1','1')";
        //var_dump($query);
