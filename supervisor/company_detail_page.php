<?php
   ...
   $docs= mysqli_query($conn,"SELECT company_docs.*,grouping.name AS typeName FROM company_docs LEFT JOIN grouping ON grouping.id=company_docs.type where company_id='$id'");
