...
if (isset($_POST['submit'])) {
    ...
    $sql=mysqli_query($conn,"INSERT INTO employee(name,email,password,contact,alt_contact,street,city,state,zip,country,supervisor_id) VALUES('$name','$email','$password','$phone','$altphone','$address','$city','$state','$zip','$country','$user_id')");
    if ($sql==true) {
