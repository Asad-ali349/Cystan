...
$comp=mysqli_query($conn,"SELECT company.* FROM supervisor LEFT JOIN employee ON employee.supervisor_id=supervisor.id LEFT JOIN company ON company.managed_by=employee.id  WHERE company.manage_role='2' AND supervisor.id='1' AND company.status='1' UNION SELECT company.* FROM company  WHERE company.manage_role='1' AND company.managed_by='1' AND company.status='1'");
$is_searched=0;
                                    ...
                                    <tr>
                                        ...
                                        <td> <span class="shadow-none badge badge-success"><?php 
                                                if ($data['manage_role']==0) {
                                                    ...
                                                    $get_manage_by=mysqli_fetch_array(mysqli_query($conn,"SELECT name FROM supervisor where id='$managed_by'"));
                                                     echo $get_manage_by['name']." (supervisor)";
                                                 }elseif ($data['manage_role']==2) {
                                                    $managed_by=$data['managed_by'];
                                                     $get_manage_by=mysqli_fetch_array(mysqli_query($conn,"SELECT name FROM employee where id='$managed_by'"));
                                                      echo $get_manage_by['name']." (employee)";
                                                 } 
                                            ?>
                                        </td>
