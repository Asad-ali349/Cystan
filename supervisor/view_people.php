...
$people=mysqli_query($conn,"SELECT employee.name AS emp_name,individual.*,grouping.name AS group_name FROM supervisor LEFT JOIN employee ON employee.supervisor_id=supervisor.id LEFT JOIN individual ON individual.manage_by=employee.id LEFT JOIN grouping ON grouping.id=individual.group_id WHERE individual.manage_role='2' AND supervisor.id='$user_id'  AND individual.status='1'");

$superpeople=mysqli_query($conn,"SELECT individual.*,grouping.name AS group_name FROM individual LEFT JOIN grouping ON grouping.id=individual.group_id WHERE individual.manage_role='1' AND individual.manage_by='$user_id' AND individual.status='1'" );
                        ...
                        <div class="widget-content widget-content-area br-6 mt-2">
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    <?php  
                                        $count=1;
                                        while ($data=mysqli_fetch_array($superpeople)) {
                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="people_detail_page.php?id=<?php echo $data['id']?>"><i class="far fa-user" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            <a href="update_people.php?id=<?php echo $data['id']?>"><i class="far fa-edit" style="color: blue; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
