...
if (isset($_POST['submit'])) {
    ...
    $sql=mysqli_query($conn,"INSERT INTO `vendors`(`title`, `business_type`, `address`, `phone`) VALUES ('$name','$business','$address','$phone')");
    if ($sql==true) {
...
$creditors=mysqli_query($conn,"SELECT * FROM vendors ORDER BY id DESC");
                                    ...
                                    <form action="" method="POST" >
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" required list="suggestions">
                                                <datalist id="suggestions">
                                                    <?php
                                                    while ($data1=mysqli_fetch_array($creditors)) {
                                                  ?>
                                                    <option ><?php echo $data1['title']?></option>
                                                    <?php        
                                                    }
                                                  ?>
                                                </datalist>
                                            ...
                                            <div class="form-group col-md-4">
                                                <select class="form-control select2" name="business" >
                                                    <option class="" value="">Select Business Type</option>
                                                    <?php
                                        ...
                                        <center><button type="submit" name="submit" class="btn btn-danger mt-3">Add Creditor</button></center>
                                    </form>
                                </div>
                            </div>
                        </div>
