...
if (isset($_SESSION['success']) && isset($_SESSION['error'])) {
   ...
   $docs2= mysqli_query($conn,"SELECT * FROM service_request_docs where service_request_id='$id' AND added_role!='3'");
    $service_id=$data['service_id'];
    $get_letters=mysqli_query($conn,"SELECT letter_".$service_id.".*,services.title FROM letter_".$service_id." INNER JOIN service_requests ON service_requests.id=letter_".$service_id.".req_id INNER JOIN services ON services.id=service_requests.service_id WHERE letter_".$service_id.".req_id='$id'");

     $trans=mysqli_query($conn,"SELECT transactions.*,services.title,individual.name,individual.email FROM `transactions` INNER JOIN service_requests ON service_requests.id=transactions.req_id INNER JOIN individual ON individual.id=service_requests.individual_id INNER JOIN services ON services.id=service_requests.service_id WHERE transactions.req_id='$id'");
            ...
            <div class="layout-px-spacing mt-4">
                        ...
                        <div class="row">
                           ...
                           <div class="col-xl-2 col-md-2 col-sm-6 col-6 ">
                              <?php
                                ...
                                ?>
                                    <a href="#"><span class="shadow-none badge badge-danger">
                                <?php        
                           ...
                           <div class="col-xl-2 col-md-2 col-sm-6 col-6 ">
                              <?php
                                    if ($data['status']==2) {
                                ?>  
                                    <a href="letter/letter<?php echo $data['service_id'] ?>.php?srid=<?php echo $data['id']; ?>" ><span class="shadow-none badge badge-primary"><i class="far fa-file"  aria-hidden="true" ></i> Create Letter</a>
                                <?php        
                                    }
                                ?>
               ...
               <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing mb-4">
                  <div class="widget-content-area br-6 mt-2">
                     <div class="widget-header ml-4 mt-2">
                        <div class="row">
                           <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                              <h3>Docs Details Sent From Client</h3>
                           </div>
                        </div>
                     </div>
                     <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>  <a href="<?php echo "../documents/".$data2['document'];?>"  target="_blank" style="color:blue"><?php echo $data2['document']; ?></a>
                              </td>
                              <td>
               ...
               <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing mb-4">
                  <div class="widget-content-area br-6 mt-2">
                     ...
                     <table id="html71-extension" class="table table-hover non-hover" style="width:100%">
                        <thead>
                           <tr>
                              <th>#</th>
                              <th class="dt-no-sorting">Name</th>
                        ...
                        <tbody>
                           <?php  
                              $count=1;
                              while ($data3=mysqli_fetch_array($get_letters)) {
                              ?>
                           <tr>
                              <td><?php echo $count ?></td>
                              ...
                              <td>
                                 ...
                                 <a href="letter/letter_preview<?php echo $service_id; ?>.php?id=<?php echo $data3['id'] ?>"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                 
                                 <a href="letter/edit_letter<?php echo $service_id; ?>.php?lid=<?php echo $data3['id'] ?>"><i class="far fa-edit" style="color: blue; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>

                                 <a href="deleteGroup.php?id=<?php echo $data3['id'];?>&table=letter_<?php echo $service_id ?>&page=request_detail_page.php?id=<?php echo $id?>" onclick="return confirm('Are you sure?')"><i class="far fa-times-circle" style="color: red; font-size: 20px;" aria-hidden="true"></i></a>
