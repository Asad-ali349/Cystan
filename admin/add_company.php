...
if (isset($_POST['submit'])) {
    ...
    $sql=mysqli_query($conn,"INSERT INTO company(name,website,total_employees,parent_company_id,contact,email,street,city,state,zip,country,review_avg,review_count,credit_score,anual_revenue,latitude,longitude,naics_id,group_id,is_company,customer_id,loan_number,ein) VALUES('$name','$url','$employee','$parent','$phone','$email','$address','$city','$state','$zip','$country','$average','$count','$score','$revenue','$latitude','$longitude','$naics','$companyGroup','1','$idNumber','$loan','$ein')");
    if ($sql==true) {
                                ...
                                <div class="widget-content widget-content-area">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="url" class="form-control" id="email" name="url" placeholder="Enter Url" >
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                <select class="form-control select2" name="naics" id="naics" required >
                                                    <option value="">Select NAICS</option>
                                                    <?php
                                                    while ($data2=mysqli_fetch_array($naicss)) {
                                                    ?>
                                                    <option value="<?php echo $data2['id']; ?>"><?php echo $data2['naics_code']." - ".$data2['description']; ?></option>
                                                    <?php        
                                                    }
                                                  ?>
                                                </select>
