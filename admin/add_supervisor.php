...
if (isset($_POST['submit'])) {
    ...
    $sql=mysqli_query($conn,"INSERT INTO supervisor(name,email,password,contact,alt_contact,street,city,state,zip,country) VALUES('$name','$email','$password','$phone','$altphone','$address','$city','$state','$zip','$country')");
    if ($sql==true) {
         $success="Supervisor Added";
    }else{
                            ...
                            <div class="statbox widget box box-shadow mb-4">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form action="" method="POST">
                                        ...
                                        <center><button type="submit" name="submit" class="btn btn-danger mt-3">Add Supervisor</button></center>
                                    </form>
                                </div>
                            </div>
                        </div>
