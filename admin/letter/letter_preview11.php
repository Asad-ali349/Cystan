...
$lid=$_GET['id'];
$letter=mysqli_fetch_array(mysqli_query($conn,"SELECT letter_11.*,bureau.*,individual.name,individual.email,individual.street,individual.state,individual.city,individual.zip,individual.ssn,individual.signature,individual.phone FROM `letter_11` INNER JOIN bureau ON letter_11.b_id=bureau.id INNER JOIN service_requests ON service_requests.id=letter_11.req_id INNER JOIN individual on individual.id=service_requests.individual_id where letter_11.id='$lid'"));
                                                            ...
                                                            <div class="inv--product-table-section">
                                                                <div class="row">
                                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-5">
                                                                        <p class="inv-to">RE:   CONSUMER STATEMENT TO MAKE CREDIT FILE COMPLETE</p>
                                                                        <p><?php echo "To Whom It May Concern:" ?></p>
                                                                    </div>
                                                                </div>
                                                                <p>
                                                                    According to the Fair Credit Reporting Act, § 611(b) [USC 15 1681i(b)], I am entitled to enter a consumer statement in my credit report so that the information is complete and the credit reporting process is fair and equitable to me. I would like the following statement to be made a part of my permanent record so that potential future creditors will be aware of certain circumstances that caused negative credit information<br>
                                                                    </p>
                                                                    <?php echo htmlspecialchars_decode($letter['consumer_statement']) ?>
                                                                    <?php echo htmlspecialchars_decode($letter['note']) ?><p>
                                    ...
                                    <div class="invoice-actions-btn">
                                        ...
                                        <div class="invoice-action-btn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-md-3 col-sm-6">
                                                    <a href="edit_letter11.php?lid=<?php echo $lid ?>" class="btn btn-primary btn-download">Edit</a>
                                                </div>
                                            </div>
