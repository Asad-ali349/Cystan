<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"INSERT INTO `letter_10`(b_id,datee,req_id,note,consumer_statement) VALUES('$bureau','$date','$srid','$additional','$consumer_statement')");
        if ($add_letter) {
        	$get_id=mysqli_fetch_array(mysqli_query($conn,"SELECT id from letter_10 WHERE b_id='$bureau' AND datee='$date' AND req_id='$srid' AND note='$additional' AND consumer_statement='$consumer_statement'"));
                $lid=$get_id['id'];
                
            header("Location: letter_preview10.php?id=$lid"); 
            // echo $lid;   
        }else{
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h2>Consumer Statement for Disputed Items </h2>
                                    </div>
                                </div>
                            </div>
