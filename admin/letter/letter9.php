<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"INSERT INTO `letter_9`(b_id,datee,req_id,note,consumer_statement) VALUES('$bureau','$date','$srid','$additional','$consumer_statement')");
        if ($add_letter) {
        	$get_id=mysqli_fetch_array(mysqli_query($conn,"SELECT id from letter_9 WHERE b_id='$bureau' AND datee='$date' AND req_id='$srid' AND note='$additional' AND consumer_statement='$consumer_statement'"));
                $lid=$get_id['id'];
                                ...
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-12 mt-4" >
                                            ...
                                            <textarea id="editor" required name="consumer_statement" rows="5"></textarea>
                                        </div>
                                        <div class="form-group col-md-12 mt-4" >
