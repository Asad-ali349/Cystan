...
$lid=$_GET['id'];
$letter=mysqli_fetch_array(mysqli_query($conn,"SELECT letter_9.*,bureau.*,individual.name,individual.email,individual.street,individual.state,individual.city,individual.zip,individual.ssn,individual.signature,individual.phone FROM `letter_9` INNER JOIN bureau ON letter_9.b_id=bureau.id INNER JOIN service_requests ON service_requests.id=letter_9.req_id INNER JOIN individual on individual.id=service_requests.individual_id where letter_9.id='$lid'"));
                                    ...
                                    <div class="invoice-actions-btn">
                                        ...
                                        <div class="invoice-action-btn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-md-3 col-sm-6">
                                                    <a href="edit_letter9.php?lid=<?php echo $lid ?>" class="btn btn-primary btn-download">Edit</a>
                                                </div>
                                            </div>
