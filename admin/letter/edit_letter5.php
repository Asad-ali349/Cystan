<?php 
    ...
    $lid=$_GET['lid'];
    $letter5=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM letter_5 WHERE id='$lid'"));
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"UPDATE `letter_5` SET b_id='$bureau',datee='$date',note='$additional',fdate='$fdate' WHERE id='$lid'");
        if ($add_letter) {
        	
        // echo $fdate;
            header("Location: letter_preview5.php?id=$lid");    
        }else{
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h2>Failure to Respond to Deletion/Correction Letter </h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label>Date:</label>
                                            <input type="date" name="date" required value="<?php echo $letter5['datee'] ?>" class="form-control"> 
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label>Insert date of first letter:</label>
                                            <input type="date" name="fdatee" value="<?php echo $letter5['fdate'] ?>" required class="form-control"> 
                                        </div>
                                        
                                        
                                        <div class="form-group col-md-12 mt-4" >
                                            <label>Additional Notes</label>
                                            <textarea id="editor" name="additional" rows="5"><?php echo $letter5['note'] ?></textarea>
                                        </div>
                                        <hr>
                                    </div>
