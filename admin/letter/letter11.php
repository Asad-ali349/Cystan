<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $add_letter=mysqli_query($conn,"INSERT INTO `letter_11`(b_id,datee,req_id,note,consumer_statement) VALUES('$bureau','$date','$srid','$additional','$consumer_statement')");
        if ($add_letter) {
        	$get_id=mysqli_fetch_array(mysqli_query($conn,"SELECT id from letter_11 WHERE b_id='$bureau' AND datee='$date' AND req_id='$srid' AND note='$additional' AND consumer_statement='$consumer_statement'"));
                $lid=$get_id['id'];
                
            header("Location: letter_preview11.php?id=$lid"); 
            // echo $lid;   
        }else{
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h2>Consumer Statement to Make Credit File Complete</h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form action="" method="POST" >
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-6" required>
                                            <label>Bureau:</label>
                                            <select class="form-control select2" id="letter" name="bureau" required>
                                        ...
                                        <div class="form-group col-md-12 mt-4" >
                                            ...
                                            <textarea id="editor" name="consumer_statement" rows="5" required></textarea>
                                        </div>
                                        <div class="form-group col-md-12 mt-4" >
                                            <label>Additional Notes</label>
                                            <textarea id="editor1" name="additional" rows="5"></textarea>
                                        </div>
                                        <hr>
                                    </div>
