...
if (isset($_POST['submit'])) {
    $name=$_POST['name'];
        ...
        $addGroup=mysqli_query($conn,"INSERT INTO grouping(name,pin_color_id,category_id) VALUES('$name','0','6')");
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="deleteGroup.php?id=<?php echo $data['id'];?>&table=grouping&page=add_service_group.php" onclick="return confirm('Are you sure?')"><i class="far fa-times-circle" style="color: red; font-size: 20px;" aria-hidden="true"></i></a>
