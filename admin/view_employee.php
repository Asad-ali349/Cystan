...
$sql=mysqli_query($conn,"SELECT employee.*,supervisor.name As Supervisor FROM employee INNER JOIN supervisor ON employee.supervisor_id = supervisor.id ORDER BY employee.id DESC");
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="justify-content-center"><span class="shadow-none badge badge-success ">
                                            <?php 
                                                $empid=$data['id'];
                                                $company_count=mysqli_query($conn,"SELECT COUNT(*) AS count from individual where manage_by='$empid' AND manage_role='2'");
