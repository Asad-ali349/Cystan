     ...
     if(in_array($extension, $allowed_extension)) //check selected file extension is present in allowed extension array
     {
      ...
      foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
      {
       ...
       for($row=2; $row<=$highestRow; $row++)
       {
        ...
        $sql=mysqli_query($conn,"INSERT INTO individual(name,phone,email,street,city,state,zip,country,credit_score,lattitude,longitude,id_number,loan_number) VALUES('$name','$phone','$email','$street','$city','$state','$zip','$country','$credit_score','$latitude','$longitude','$id_number','$loan_number')");
