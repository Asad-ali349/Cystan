...
$error="";
$sid=$_GET['id'];
$get_sup=mysqli_query($conn,"SELECT * FROM supervisor WHERE id='$sid'");
$result=mysqli_fetch_array($get_sup);
// title price image service_type note

$ind=mysqli_query($conn,"SELECT * FROM individual WHERE manage_by='$sid' AND manage_role='1' AND status='1'");
$sql=mysqli_query($conn,"SELECT employee.*,supervisor.name As Supervisor FROM employee INNER JOIN supervisor ON employee.supervisor_id = supervisor.id WHERE employee.supervisor_id='$sid' AND employee.status='1' ORDER BY employee.id DESC");
                                ...
                                <div class="user-profile layout-spacing mt-2">
                                    <div class="widget-content widget-content-area " >
                                        <div class="d-flex justify-content-between">
                                            <h3 class="">Profile</h3>
                                            <a href="update_supervisor.php?id=<?php echo $sid;?>" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
                                        </div>
