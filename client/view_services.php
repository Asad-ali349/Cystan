                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="add_service_req.php?sid=<?php echo $data['id'] ?>"><i class="far fa-send" style="color: blue; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                        ...
                                        <div class="modal bd-example-modal-xl fade" id="req<?php echo $count; ?>" tabindex="-1" role="dialog">
                                          <div class="modal-dialog modal-xl" role="document">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title"><strong style="color: #E72913;font-weight: 700;font-size: 24px">Service Title: </strong><?php echo $data['title']; ?></h5>
                                                ...
                                                <form  action="uplaoddoc.php" method="POST" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="card-body">
