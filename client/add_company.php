<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql=mysqli_query($conn,"INSERT INTO company(name,website,total_employees,parent_company_id,contact,email,street,city,state,zip,country,review_avg,review_count,credit_score,anual_revenue,latitude,longitude,naics_id,group_id,is_company,added_by,roll,customer_id,loan_number,managed_by,manage_role,ein,owned_by) VALUES('$name','$url','$employee','$parent','$phone','$email','$address','$city','$state','$zip','$country','$average','$count','$score','$revenue','$latitude','$longitude','$naics','$companyGroup','1','$manage_by','$manage_role','$idNumber','$loan','$manage_by','$manage_role','$ein','$user_id')");
