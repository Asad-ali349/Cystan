...
if (isset($_SESSION['success']) && isset($_SESSION['error'])) {
  ...
  $ser_req=mysqli_query($conn,"SELECT transactions.*,services.title,individual.name FROM `transactions` INNER JOIN service_requests ON service_requests.id=transactions.req_id INNER JOIN individual ON individual.id=service_requests.individual_id INNER JOIN services ON services.id=service_requests.service_id WHERE service_requests.individual_id='$user_id'");
                            ...
                            <table id="html5-extensions" class="table table-hover non-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="dt-no-sorting">Service Name</th>
